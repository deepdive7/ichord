...
import (
	...
	"github.com/edenzhong7/ifly/codec"
	"github.com/edenzhong7/ifly/codec/json"
	"github.com/edenzhong7/ifly/crypto"
)
...
func (c *Cluster) Listen(ln net.Listener) error {
	defer ln.Close()
...
func (c *Cluster) Join(ip string, port int) error {
	c.debug("Joining Chord DHT using source node %v:%v", ip, port)
